...
/**
 * @OA\PathItem(
 * path="/api/advertisers/{advertiserId}/billing/payment_methods"
 * )
 * @OA\Tag(
 *     name="advertisers_billing_payment_methods",
 *     description="User related operations"
 * )
 */
class AdvertisersBillingPaymentMethodController extends ApiController
{
    private $repository;
    ...
    /**
     * @OA\Get(
     *  path="/api/advertisers/{advertiserId}/billing/payment_methods/all",
     *  tags={"advertisers_billing_payment_methods"},
     *  security={{"bearerAuth":{}}},
     *  summary="Delete advertiser billing/payment_methods",
     *       @OA\Parameter(
     *          name="advertiserId",
     *          in="path",
     *          required=true, 
    ...
    {
        return response()->json($this->repository->feed_payment_methods($advertiserId), 200);
    }

    /**
     * @OA\Put(
     *  path="/api/advertisers/{advertiserId}/billing/payment_methods/select{id}",
     *  tags={"advertisers_billing_payment_methods"},
     *  security={{"bearerAuth":{}}},
     *  summary="Delete advertiser billing/payment_methods",
     *       @OA\Parameter(
    ...
    {
        $result = $this->repository->select_payment_method($advertiserId, $id);
