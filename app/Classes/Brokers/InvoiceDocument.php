...
class InvoiceDocument
{
    ...
    public function render_to_output()
    {
        ...
        $to = array_merge([$details['organization_name']], (array)$details['organization_address']);
        if (!empty($details['registration_number'])) {
            $to[] = $details['registration_number'];
        }
        $doc->setTo($to);
    ...
    public static function get_billing_entity_details($billing_entity)
    {
        ...
        return [
            ...
            'registration_number' => $billing_entity['registration_number'],
