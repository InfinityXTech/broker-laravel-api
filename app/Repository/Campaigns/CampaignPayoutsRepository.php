...
class CampaignPayoutsRepository extends BaseRepository implements ICampaignPayoutsRepository
{
    /**
     * @var Model
     */
     ...
     * @param Model $model
     */
    public function __construct(MarketingCampaignPayout $model)
    {
        $this->model = $model;
    }
    ...
    public function log(string $payoutId, $limit = 20): array
    {
        $where = [
            ...
            'collection' => 'marketing_campaign_payouts'
        ];
        ...
        for ($i = 0; $i < count($history_logs); $i++) {
            ...
            $response[] = [
                ...
                'data' => implode(', ', array_filter([
                    ...
                    $diff->value('advertiser_payout', 'Advertiser Payout'),
                    $diff->value('affiliate_payout', 'Affiliate Payout'),
