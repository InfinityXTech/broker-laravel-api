...
class MontlyMoneyReportCron extends BaseCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'MontlyMoneyReportCron:cron';
        ...
        try {
            ...
            foreach ($clients as $client) {
                ...
                if (isset($result) && isset($result['totals'])) {
                    ...
                    $content = 'MTD ' . date('d/m', $start) . " - " . date('d/m', time()) . PHP_EOL .
            ...
            Log::info("Cron MontlyMoneyReportCron!");
        } catch (\Exception $ex) {
            Log::info("Cron MontlyMoneyReportCron Error: " . $ex->getMessage());
        }
    }
}
